from Embedding_models.Diff2Vec.subgraphcomponents import SubGraphComponents
...
def learn_embeddings(walks, args):
    ...
    model.wv.save_word2vec_format(args.output+"diff2vec"+ str(args.dimensions) +".emb")


def main(args):
    print("diff2vec started")
