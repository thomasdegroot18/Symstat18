...
from Embedding_models.Struc2Vec.utils import *
import os
...
def calc_distances(part, compactDegree = False):
    ...
    print(len(vertices.items()))
    size = len(vertices.items())
    j = 0
...
def alias_setup(probs):
    '''
    Compute utility lists for non-unifodel sampling from discrete distributions.
